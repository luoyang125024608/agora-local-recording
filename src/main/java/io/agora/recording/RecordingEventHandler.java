...
public interface RecordingEventHandler {
   ...
   * @param state Indicates the current state of the remote user's video stream. For details, see {@link Common.REMOTE_STREAM_STATE REMOTE_STREAM_STATE}.
   * @param reason Indicates the reason causing the state change. For details, see {@link Common.REMOTE_STREAM_STATE_CHANGED_REASON REMOTE_STREAM_STATE_CHANGED_REASON}.
   */
   ...
   *
   * @param uid The `uid` of the remote user.
   * @param state Indicates the current state of the remote user's audio stream. For details, see {@link Common.REMOTE_STREAM_STATE REMOTE_STREAM_STATE}.
   * @param reason Indicates the reason causing the state change. For details, see {@link Common.REMOTE_STREAM_STATE_CHANGED_REASON REMOTE_STREAM_STATE_CHANGED_REASON}.
   */
   ...
   *
   * @param uid The `uid` of the user.
   * @param frame Received raw audio data in PCM or AAC format. See {@link Common.AudioFrame AudioFrame}.
   */
   ...
   *  <li>4: JPG file</li>
   * </ul>
   * @param frame Received video frame. See {@link Common.VideoFrame VideoFrame}.
   ...
   *
   * @param state The current network connection state. See {@link Common.CONNECTION_STATE_TYPE CONNECTION_STATE_TYPE}.
   * @param reason The reason causing the change of the connection state. See {@link Common.CONNECTION_CHANGED_REASON_TYPE CONNECTION_CHANGED_REASON_TYPE}.
   */
   ...
   *
   * @param stats The statistics of the received remote video stream. See {@link Common.RemoteVideoStats RemoteVideoStats}.
   */
   ...
   *
   * @param stats The statistics of the received remote audio stream. See {@link Common.RemoteAudioStats RemoteAudioStats}.
   */
   ...
   *
   * @param stats See {@link Common.RecordingStats RecordingStats}.
   */
